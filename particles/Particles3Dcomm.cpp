...
int Particles3Dcomm::communicate(VirtualTopology3D* ptVCT){
    ...
    if (npExitingMax > 0){
        ...
        // UNBUFFERING
        // message from XLEFT
        avail1 = unbuffer(b_X_RIGHT); avail2 = unbuffer(b_X_LEFT); avail3 = unbuffer(b_Y_RIGHT); avail4 = unbuffer(b_Y_LEFT); avail5 = unbuffer(b_Z_RIGHT); avail6 = unbuffer(b_Z_LEFT);
